...
export default function ContentDetailPage() {
  ...
  const twShareUrl = `https://twitter.com/intent/tweet?url=${encodeURIComponent(shareUrl)}&text=${encodeURIComponent(content.title)}`;
        ...
        <div className="px-4 sm:px-6 lg:px-10 py-6 sm:py-8 lg:py-10 space-y-6 sm:space-y-8">
          ...
          <div className="flex items-center gap-3 pt-6 border-t border-gray-200">
            <a
              ...
              className="flex items-center gap-2 px-5 py-2 border-2 border-[#2f3a9a] text-[#2f3a9a] rounded-lg text-sm font-semibold hover:bg-[#2f3a9a] hover:text-white transition-colors"
            >
